  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Construction Tool Rental v1 - your central hub for renting construction tools from multiple outlets, making it easier and more efficient for individual customers."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Construction Tool Rental v1 - your central hub for renting construction tools from multiple outlets, making it easier and more efficient for individual customers.`}
            </Text>
            <Box
